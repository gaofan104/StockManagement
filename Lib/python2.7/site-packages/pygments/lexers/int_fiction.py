    ...
    tokens = {
        ...
        'directive-js': [
            ...
            (r'(?i)(array|global)\b', Keyword,
             ('default', 'directive-js-keyword?', '_global')),
            ...
            (r'(?i)statusline\b', Keyword, ('default', 'directive-js-keyword?')),
            (r'(?i)stub\b', Keyword, ('default', 'routine-name?')),
            (r'(?i)trace\b', Keyword,
             ('default', 'trace-keyword?', 'trace-keyword?')),
            (r'(?i)zcharacter\b', Keyword,
             ('default', 'directive-js-keyword?', 'directive-js-keyword?')),
        ...
        'diagnostic': [
            ...
            default(('#pop', 'before-plain-string', 'directive-js-keyword?'))
        ],
        'before-plain-string': [
            include('_whitespace'),
        ...
        'statements': [
            ...
            (r'\.', Name.Label, 'label?'),
            (r'@', Keyword, 'opcode'),
            (r'#(?![agrnw]\$|#)', Punctuation, 'directive-js'),
            ...
            '+main': [
                ...
                (r'(\([%s])(.*?)([%s]\))' % (_dash, _dash),
                 bygroups(Punctuation,
                          using(this, state=('+i6-root', 'directive-js'),
