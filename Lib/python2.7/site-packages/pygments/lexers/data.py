...
class YamlLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            # a comment
            (r'#[^\n]*', Comment.Single),
            # the '%YAML' directive-js
            (r'^%YAML(?=[ ]|$)', reset_indent(Name.Tag), 'yaml-directive-js'),
            # the %TAG directive-js
            (r'^%TAG(?=[ ]|$)', reset_indent(Name.Tag), 'tag-directive-js'),
