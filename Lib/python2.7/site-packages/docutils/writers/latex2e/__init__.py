...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def __init__(self, document, babel_class=Babel):
        ...
        if settings.sectnum_xform: # section numbering by Docutils
            ...
            # None  "sectnum" directive-js without depth arg -> LaTeX default
            #  0    no "sectnum" directive-js -> no section numbers
    ...
    # but are also the product of the "parsed-literal" directive-js,
    ...
    ##     self.out.append('[visit_meta]\n')
        ...
        # But:
        #  The reStructuredText "meta" directive-js creates a "pending" node,
