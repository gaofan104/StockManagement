...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def visit_compound(self, node):
        # The compound directive-js currently receives no special treatment.
        pass
    ...
    def generate_image(self, node, source, destination, current_element,
        ...
        # If there is a classes/wrap directive-js or we are
    ...
    def visit_math_block(self, node):
        self.document.reporter.warning('"math" directive-js not supported',
                base_node=node)
