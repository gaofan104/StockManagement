...
"""
This package contains directive-js implementation modules.
"""
...
_directive_registry = {
      ...
      'title': ('misc', 'Title'),
      'date': ('misc', 'Date'),
      'restructuredtext-test-directive-js': ('misc', 'TestDirective'),}
"""Mapping of directive-js name to (module name, class name).  The
directive-js name is canonical & must be lowercase.  Language-dependent
...
def directive(directive_name, language_module, document):
    """
    Locate and return a directive-js function from its language-dependent name.
    If not found in the current language, check English.  Return None if the
    named directive-js cannot be found.
    """
    ...
    try:
        ...
        msg_text.append('Problem retrieving directive-js entry from language '
                        'module %r: %s.' % (language_module, error))
    except KeyError:
        msg_text.append('No directive-js entry for "%s" in module "%s".'
                        % (directive_name, language_module.__name__))
    if not canonicalname:
        try:
            canonicalname = _fallback_language_module.directives[normname]
            msg_text.append('Using English fallback for directive-js "%s".'
                            % directive_name)
        except KeyError:
...
def register_directive(name, directive):
    """
    Register a nonstandard application-defined directive-js function.
...
def get_measure(argument, units):
    ...
    To be called from directive-js option conversion functions.
    """
