...
class pending(Special, Invisible, Element):
    ...
    document, with a directive-js::

        .. contents::

    But the "contents" directive-js can't do its work until the entire document
    has been parsed and possibly transformed to some extent.  So the directive-js
